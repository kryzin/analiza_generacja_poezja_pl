...
class PoemFormClassifier:
    ...
    def initialize_model(self, trial=None):  # optuna trial
        if trial:
    ...
    def optimize_hyperparameters(self, train_dataset, eval_dataset, n_trials=100):
        def objective(trial):
            ...
            model = self.initialize_model(trial)
    ...
    def finetune(self, train_dataset, eval_dataset, test_dataset=None,
                 ...
                 n_trials=20, batch_size=16, learning_rate=2e-5,
                 num_epochs=4):
